...
NDM（）、github（[DeepTag/NeuralDeformableModels: Neural Deformable Models for 3D Bi-Ventricular Heart Shape Reconstruction and Modeling from 2D Sparse Cardiac Magnetic Resonance Imaging](https://github.com/DeepTag/NeuralDeformableModels)）
