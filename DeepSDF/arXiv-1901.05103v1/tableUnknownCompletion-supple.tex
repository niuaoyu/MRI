...
\footnotesize
 ...
 \hhline{|=|=|=|=|=|=|}
  \multicolumn{1}{|l|}{Mesh comp., mean} & \multicolumn{1}{c|}{chair} & \multicolumn{1}{c|}{plane} & \multicolumn{1}{c|}{table} & \multicolumn{1}{c|}{lamp} & \multicolumn{1}{c|}{sofa}  \\
% \multicolumn{1}{cl|}{Method \& metric} & chair & plane & table & sofa & lamp & avg & inference\\
 ...
 \hline
   \hhline{|=|=|=|=|=|=|}
%  CD, median    &    &  &   &   & \\
  \multicolumn{1}{|l}{Mesh comp., median} &  \multicolumn{1}{c}{ \ } &  \multicolumn{1}{c}{ \ } &  \multicolumn{1}{c}{ \ } &  \multicolumn{1}{c}{ \ }  &  \multicolumn{1}{c|}{} \\
 \hline
  AtlasNet-Sph.  & 0.686 & 0.930 & 0.795 & 0.257 & 0.666  \\
 AtlasNet-25      & 0.736 & 0.944 & 0.825 & 0.533 & 0.702  \\
 DeepSDF        & \bf{0.970} & \bf{0.970} & \bf{0.982} & \bf{0.930} & \bf{0.941}  \\
 \hline
  \hhline{|=|=|=|=|=|=|}
%  CD, median    &    &  &   &   & \\
